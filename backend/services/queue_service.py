        ...
        try:
            ...
            self._jobs = [
                Job(
                    ...
                    subtitle_tracks=d.get("subtitle_tracks"),
                    audio_bitrate=d.get("audio_bitrate"),
                    keep_all_audio=d.get("keep_all_audio", True),
                    keep_all_subtitles=d.get("keep_all_subtitles", True),
                )
                for d in raw
            ]
