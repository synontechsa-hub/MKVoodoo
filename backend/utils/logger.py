...
class SynLogger:
    ...
    def file_success(
        self, source: str, output: str, preset: str, encoder: str, start_time: float, job_id: str = ""
    ) -> None:
    ...
    def file_failed(
        self, source: str, output: str, preset: str, encoder: str, start_time: float, error: str, job_id: str = ""
    ) -> None:
        elapsed = time.monotonic() - start_time
        prefix = f"[{job_id}] " if job_id else ""
        with self._lock:
